...
namespace SceneServer{
	...
	INT32	CSSCfgMgr::LoadSSHeroBornCfg()
	{
		...
		const char *cfg = "CSBattleMgr/MapConfig/SS_HeroBirthConfig.xml";
	...
	INT32	CSSCfgMgr::LoadSSMapPathPointCfg()
	{
		...
		const char* cfg = "CSBattleMgr/MapConfig/SS_SoldierWaypoints.xml";  
	...
	INT32		CSSCfgMgr::LoadSSMapSolderInfoCfg()
	{
		...
		const char* cfg = "CSBattleMgr/MapConfig/SS_MapBaseConfig.xml";   
	...
	INT32		CSSCfgMgr::LoadSSMapAltarSolderInfoCfg()
	{
		...
		const char* cfg = "CSBattleMgr/MapConfig/SS_AltarConfig.xml";    
	...
	INT32		CSSCfgMgr::LoadSSMapFunDelayCfg()
	{
		...
		const char* cfg = "CSBattleMgr/MapConfig/SS_DelayConfig.xml";    
	...
	INT32		CSSCfgMgr::LoadSSMapWildMonsterCfg()
	{
		...
		const char* cfg = "CSBattleMgr/MapConfig/SS_CreepsConfig.xml";    
	...
	INT32		CSSCfgMgr::LoadSSGuideHeroCfg()
	{
		...
		const char* cfg = "CSBattleMgr/SSGuideCfg/SS_bornhero.xml";    
	...
	{ 
		...
		const char* cfg = "CSBattleMgr/SSGuideCfg/SS_bornnpc.xml";    
	...
	INT32	CSSCfgMgr::LoadSSGuideUserHeroCfg()
	{
		...
		const char* cfg = "CSBattleMgr/SSGuideCfg/SS_userHero.xml";    
	...
	INT32		CSSCfgMgr::LoadSSGuideHurtObjCfg()
	{
		...
		const char* cfg = "CSBattleMgr/SSGuideCfg/SS_BuildBeHurt.xml";    
